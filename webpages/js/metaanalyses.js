...
function requestAndFillMetaanalysis() {
  ...
  function fillMetaanalysis(metaanalysis) {
    ...
    var paper1 = {
      "id": "/id/p/1476385486001",
      "title": "Hi11",
      "enteredBy": "tomas.rubin@port.ac.uk",
      "ctime": 1476385486001,
      "mtime": 1476385673768,
      "description": "Higham, Luna & Bloomfield (2011). Exp. 1 used a combination of a pre- and a post-warning and is therefore not included here. Exp. 2: ‘low’ and ‘high’ refer to low and high incentives for participants to provide accurate memory test answers. The memory performances are collapsed across fine- and coarse-grained answers as well as across testify option (as none of these distinctions figured in other studies; see Higham et al., 2011, for details; collapsed data provided by Phil Higham). ",
      "tags": [

      ],
      "apiurl": "/api/papers/tomas.rubin@port.ac.uk/Hi11",
      "experiments": [
        {
          "enteredBy": "tomas.rubin@port.ac.uk",
          "title": "Ex2low",
          "ctime": 1476385486002,
          "data": {
            "/id/col/1473862498238": {
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385651677,
              "value": "23"
            },
            "/id/col/1473862556299": {
              "value": "36",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385651676
            },
            "/id/col/1473862816562": {
              "value": "",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385556483
            },
            "/id/col/1473674165950": {
              "value": "STA",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385568588
            },
            "/id/col/1473674338961": {
              "value": "FC",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385595492
            },
            "/id/col/1473674381680": {
              "value": "PRES",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385595493
            },
            "/id/col/1473675957572": {
              "value": "64",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385636847
            },
            "/id/col/1473862393996": {
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385662769,
              "value": "0.67"
            },
            "/id/col/1473674325686": {
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385595491,
              "value": "Short"
            },
            "/id/col/1473862978234": {
              "value": "Short",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385568589
            },
            "/id/col/1473674247769": {
              "value": "12",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385568590
            },
            "/id/col/1473676242844": {
              "value": "0.67",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385636849
            },
            "/id/col/1473674399109": {
              "value": "No",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385606198
            },
            "/id/col/1473863033709": {
              "value": "STU",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385556484
            },
            "/id/col/1473862837066": {
              "value": "20",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385556482
            },
            "/id/col/1473674426751": {
              "value": "No",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385606199
            },
            "/id/col/1473862463348": {
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385636848,
              "value": "78"
            },
            "/id/col/1473674288254": {
              "value": "CON",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476385582130
            }
    ...
    var paper2 = {
      "id": "/id/p/1476279383995",
      "title": "Ch83",
      "enteredBy": "tomas.rubin@port.ac.uk",
      "ctime": 1476279383995,
      "mtime": 1476382087780,
      "description": "Christiaansen & Ochalek (1983).",
      "tags": [

      ],
      "apiurl": "/api/papers/tomas.rubin@port.ac.uk/Ch83",
      "experiments": [
        {
          "enteredBy": "tomas.rubin@port.ac.uk",
          "title": "Ex1",
          ...
          "data": {
            ...
            "/id/col/1473862317563": {
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476279581846,
              "value": "3.31"
            },
            "/id/col/1473862515985": {
              "value": "5",
              "enteredBy": "tomas.rubin@port.ac.uk",
              "ctime": 1476279603359
            },
